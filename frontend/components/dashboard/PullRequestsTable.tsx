...
import { PRFeedbackPanel } from "./PRFeedbackPanel";
              ...
              {prs.length === 0 ? (
                ...
                prs.map((pr) => (
                  <tr
                    ...
                    className="group dark:hover:bg-neutral-800/40 hover:bg-neutral-50/80 transition-all duration-200 cursor-pointer"
                  >
